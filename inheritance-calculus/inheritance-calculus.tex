...
of~\cite{scott1972-continuous-lattices,wadsworth1976-scott-d-infinity-models,abramsky2000-full-abstraction-pcf,hyland2000-full-abstraction-pcf,barendregt1984-lambda-calculus}
...
\begin{description}
  ...
  \item[$\mathrm{lfp}(T_P)$ is strictly more
    ...
    , thus having no abstraction shape.
...
of enclosing scope levels, represented by record braces, between the
...
tree~\cite{barendregt1984-lambda-calculus} of the original term:
