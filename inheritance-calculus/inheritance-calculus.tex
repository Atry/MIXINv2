...
\[
  \mathrm{NatData} \mapsto \left\{
    \begin{aligned}
      &\mathrm{NatFactory} \mapsto \left\{
        \begin{aligned}
          &\mathrm{Product} \mapsto \{\},\\
          &\mathrm{Zero} \mapsto \{\mathrm{Product}\},\\
          &\mathrm{Successor} \mapsto \left\{\mathrm{Product},\; \mathrm{predecessor} \mapsto \{\mathrm{Product}\}\right\}
      \end{aligned}\right\},\\
...
\[
  \mathrm{NatPlus} \mapsto \left\{
    \begin{aligned}
      ...
      &\mathrm{NatFactory} \mapsto \left\{
        \begin{aligned}
          &\mathrm{Product} \mapsto \left\{\mathrm{Plus} \mapsto \left\{\mathrm{sum} \mapsto \{\mathrm{Product}\}\right\}\right\},\\
          &\mathrm{Zero} \mapsto \left\{\mathrm{Plus} \mapsto \left\{
              \begin{aligned}
                &\mathrm{addend} \mapsto \{\mathrm{Product}\},\\
                &\mathrm{sum} \mapsto \{\mathrm{addend}\}
          \end{aligned}\right\}\right\},\\
          &\mathrm{Successor} \mapsto \left\{\mathrm{Plus} \mapsto \left\{
              \begin{aligned}
                &\mathrm{addend} \mapsto \{\mathrm{Product}\},\\
...
\[
  \mathrm{NatVisitor} \mapsto \left\{
    \begin{aligned}
      ...
      &\mathrm{NatFactory} \mapsto \left\{
        \begin{aligned}
          &\mathrm{Product} \mapsto \{\mathrm{Acceptance} \mapsto \{\mathrm{Accepted} \mapsto \{\}\}\},\\
          &\mathrm{Zero} \mapsto \left\{
            \begin{aligned}
              &\mathrm{Acceptance} \mapsto \\
              &\left\{
                \begin{aligned}
            ...
            \begin{aligned}
              ...
              &\left\{
                \begin{aligned}
                  ...
                  &\{\mathrm{VisitorMap}.\mathrm{SuccessorVisitor}\}
              \end{aligned}\right\}
          \end{aligned}\right\}
      \end{aligned}\right\}
  \end{aligned}\right\}
...
$\mathrm{NatEquality}$ inherits $\mathrm{NatVisitor}$ and $\mathrm{BooleanData}$, using each as a module,
  ...
  \[
    \mathrm{NatEquality} \mapsto \left\{
      \begin{aligned}
        ...
        &\mathrm{NatFactory} \mapsto \left\{
          \begin{aligned}
            &\mathrm{Product} \mapsto \left\{\mathrm{Equal} \mapsto \left\{
                \begin{aligned}
                      ...
                      \begin{aligned}
                        ...
                        &\left\{
                          \begin{aligned}
                            ...
                            &\{\mathrm{equal} \mapsto \{\qualifiedthis{\mathrm{NatEquality}}.\mathrm{BooleanFactory}.\mathrm{True}\}\},\\
                            &\mathrm{SuccessorVisitor} \mapsto \\
                            &\{\mathrm{equal} \mapsto \{\qualifiedthis{\mathrm{NatEquality}}.\mathrm{BooleanFactory}.\mathrm{False}\}\}
                        \end{aligned}\right\},\\
                        &\mathrm{Accepted} \mapsto \{\mathrm{equal} \mapsto \{\qualifiedthis{\mathrm{NatEquality}}.\mathrm{Boolean}\}\}
                    \end{aligned}\right\},\\
            ...
            &\left\{
              \begin{aligned}
                ...
                &\left\{
                  \begin{aligned}
                    &\mathrm{other} \mapsto \left\{\mathrm{Product},\; \mathrm{predecessor} \mapsto \{\mathrm{Product}\}\right\},\\
