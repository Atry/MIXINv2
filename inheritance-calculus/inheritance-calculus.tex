...
\footnote{The executable MIXINv2
...
phenomena arose beyond those anticipated by the adopted
design patterns.
...
and associative, and self-reference naturally resolves to
\emph{multiple targets} rather than one, where prior systems
such as Scala and the NixOS module system reject the multi-path
situation.
...
Section~\ref{sec:forward-translation} translates function
application directly into inheritance, embedding the
$\lambda$-calculus and thereby establishing Turing completeness.
Section~\ref{sec:bohm-tree} shows that the translation preserves
observational equivalence: the induced semantics corresponds to
B\"ohm tree equivalence~\cite{barendregt1984-lambda-calculus},
giving the lazy $\lambda$-calculus a first-order denotational
semantics; a convergence hierarchy among eager, lazy, and fixpoint
$\lambda$-calculi sharing the same syntax follows as a corollary
...
In developing real programs in MIXINv2, three phenomena arose
beyond those anticipated by the adopted design patterns.%
\footnote{MIXINv2 programs adopt two standard patterns:
