...
\footnote{The unary Nat trie can be viewed as a sparse linked list
...
deep merge of mixin trees generalized method-level overriding
to recursive merging of nested structure,
and the resulting inheritance was commutative, idempotent, and associative,
