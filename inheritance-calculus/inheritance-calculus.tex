  ...
  {\small
    \[
      ...
      \begin{array}{c @{\quad} c c c c c}
        \multirow{5}{*}{\rotatebox[origin=c]{90}{expressiveness $\longrightarrow$}}
          & & & \text{lazy inheritance-calculus} & \subsetneq
          & \text{inheritance-calculus} \\[2pt]
        & & &
          \rotatebox[origin=c]{90}{$\subsetneq$} & &
          \rotatebox[origin=c]{90}{$\subsetneq$} \\[2pt]
        & & & \lambda \text{ sublanguage of lazy inheritance-calculus} & \subsetneq
          & \lambda \text{ sublanguage of inheritance-calculus} \\[2pt]
        & & & \rotatebox[origin=c]{90}{$\cong$} & & \\[2pt]
        & \lambda\text{-calculus} & \subsetneq
          & \text{lazy } \lambda\text{-calculus} & \subsetneq
          & \text{fixpoint } \lambda\text{-calculus}  \\[6pt]
        & \multicolumn{5}{c}{\text{convergence} \longrightarrow} \\
      \end{array}
    \]
  }
  \caption{The calculi of this paper, arranged in a grid.
    On the expressiveness axis, $A \subsetneq B$ means everything $A$
    macro-expresses in Felleisen's sense $B$ macro-expresses, and strictly
    more, and $A \cong B$ means $A$ and $B$ are fully abstract.}
