...
Appendix~\ref{app:evaluation-trace} works through a concrete example,
evaluating the six equations step by step.
We chose this example to show how the frontier $S$ lets $\this$ resolve
to several targets at once, so that a program rejected by the Scala~3
and NixOS module systems works here
