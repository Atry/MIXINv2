...
$(n,\; \ell_{\mathrm{down},*})$ of a de~Bruijn index $n$ and a list
of downward projections $\ell_{\mathrm{down},*}$.
...
Each $\inherits$ entry is a reference pair $(n,\, \ell_{\mathrm{down},*})$,
where $n$ is the number of upward steps and $\ell_{\mathrm{down},*}$ the
downward projection (Section~\ref{sec:definitions}).
