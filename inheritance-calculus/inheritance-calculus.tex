...
\[
  \mathrm{NatPlus} \mapsto \left\{\begin{aligned}
    &\mathrm{NatData},\\
    &\mathrm{NatFactory} \mapsto \left\{\begin{aligned}
      &\mathrm{Product} \mapsto \left\{\mathrm{Plus} \mapsto \left\{\mathrm{sum} \mapsto \{\mathrm{Product}\}\right\}\right\},\\
      &\mathrm{Zero} \mapsto \left\{\mathrm{Plus} \mapsto \left\{\begin{aligned}
        &\mathrm{addend} \mapsto \{\mathrm{Product}\},\\
        &\mathrm{sum} \mapsto \{\mathrm{addend}\}
      \end{aligned}\right\}\right\},\\
      &\mathrm{Successor} \mapsto \left\{\mathrm{Plus} \mapsto \left\{\begin{aligned}
        &\mathrm{addend} \mapsto \{\mathrm{Product}\},\\
    ...
    \mathrm{NatEquality} \mapsto \{\;&
      ...
      &\mathrm{NatFactory} \mapsto \{\\
        ...
        &\quad \mathrm{Zero} \mapsto \{\mathrm{Equal} \mapsto \{
            \mathrm{other} \mapsto \{\mathrm{Product}\},\\
            \intertext{\scriptsize\qquad case analysis on $\mathrm{other}$ via its $\mathrm{Acceptance}$: $\mathrm{Zero}$ branch yields $\mathrm{True}$, $\mathrm{Successor}$ branch yields $\mathrm{False}$}
            &\qquad
            \mathrm{\_OtherAcceptance} \mapsto \{
              ...
              \mathrm{VisitorMap} \mapsto \{
                \mathrm{ZeroVisitor} \mapsto \{
                  \mathrm{equal} \mapsto \{
                \qualifiedthis{\mathrm{NatEquality}}.\mathrm{BooleanFactory}.\mathrm{True}\}\},\\
                &\qquad\;\quad
                \mathrm{SuccessorVisitor} \mapsto \{
                  \mathrm{equal} \mapsto \{
              \qualifiedthis{\mathrm{NatEquality}}.\mathrm{BooleanFactory}.\mathrm{False}\}\}\},\\
              &\qquad\;
            ...
            &\qquad
            \mathrm{equal} \mapsto \{
        \mathrm{\_OtherAcceptance}.\mathrm{Accepted}.\mathrm{equal}\}\}\},\\[2pt]
        &\quad \mathrm{Successor} \mapsto \{\mathrm{Equal} \mapsto \{
            \mathrm{other} \mapsto \{
              \mathrm{Product},\;
            \mathrm{predecessor} \mapsto \{\mathrm{Product}\}\},\\
            \intertext{\scriptsize\qquad recurse on the two predecessors: $\mathrm{S}(a) = \mathrm{S}(b)$ iff $a = b$ (the $\mathrm{Successor}$ branch below reads this result)}
            &\qquad
            ...
            \mathrm{\_OtherAcceptance} \mapsto \{
              ...
              \mathrm{VisitorMap} \mapsto \{
                ...
                \mathrm{SuccessorVisitor} \mapsto \{
                  \mathrm{equal} \mapsto \{
              \mathrm{\_recursiveEquality}.\mathrm{equal}\}\}\},\\
              &\qquad\;
              \mathrm{Accepted} \mapsto \{
                \mathrm{equal} \mapsto \{
            \qualifiedthis{\mathrm{NatEquality}}.\mathrm{Boolean}\}\}\},\\
            &\qquad
            \mathrm{equal} \mapsto \{
    \mathrm{\_OtherAcceptance}.\mathrm{Accepted}.\mathrm{equal}\}\}\}\}\}
\end{align*}}
%% === 审稿人备忘：关于代码"冗长"的回应 ===
%%
