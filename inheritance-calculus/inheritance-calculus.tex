...
inheriting $\mathrm{other}.\mathrm{Acceptance}$ reads as
$\mathbf{match}\;\mathrm{other}\;\{\,\mathbf{case}\;\mathrm{Zero}\dots\;\mathbf{case}\;\mathrm{Successor}\dots\}$,
dispatching on the constructor that built $\mathrm{other}$:
{\small
  \[
