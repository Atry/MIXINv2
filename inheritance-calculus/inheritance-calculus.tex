...
existing structure from outside; their values are immutable;
and they have no first-class functions.
Note that a function body is closed: its internal structure
cannot be extended without modifying the definition---the
opposite of composition by extending from outside.
...
No known computational model is simultaneously Turing complete,
immutable, and function-free.
