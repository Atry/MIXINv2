...
never halts, so rationality is co-r.e.-hard. Hence the terminating inputs cannot be pre-selected. The readout is thus a \emph{sound semi-decision procedure}
