...
\newcommand{\stepm}{e}                       % equation morphism (iterative coalgebra)
...
An \emph{iterative coalgebra} is given by an \emph{equation morphism}
\[
...
guarded-cycle case of the present behaviour map, reached by different routes; the difference is one of
