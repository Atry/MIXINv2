...
call-by-value regions out of an otherwise interpreted program. A bound variable is named for
readability and the binder at level $k$ is the Python parameter $\mathtt{v}k$; the listings are
