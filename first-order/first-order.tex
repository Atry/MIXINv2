...
\citeTODO{piróg-gibbons} are the home of the equation morphism of Definition~\ref{def:itcoalg}.
...
rests on, transported from logic programming to an arbitrary equation morphism.
...
\citeTODO{bird} is a known obstacle. We add nothing to the calculus: it is one equation morphism
...
behaviour of an arbitrary equation morphism, read by tabling on first-order state identity, with the
