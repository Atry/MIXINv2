...
arithmetic applications execute in Python and compute what the source terms compute. Decoded to
call-by-name Python, the lazy semantics matching the interpreter's weak-head reduction, every
normalizing term computes its value, factorial and Fibonacci among them, and the prelude arithmetic
is cross-checked on both the interpreter and the compiler.
