...
A real speedup would need the recursion itself to run natively, that is an analysis whose recursion is
structurally total and so an island in its own right, a redesign of the analysis rather than a
compilation option.
