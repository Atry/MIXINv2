...
finite-state model checking but not infinite-state.
...
Kleene, sense (Definition~\ref{def:rational}).
...
identically, and a different term reads out differently.
