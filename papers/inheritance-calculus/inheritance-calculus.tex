...
Inheritance-calculus is thus strictly more defined than the
...
(L\'evy--Longo) semantics and changes only the evaluator.
...
refines, so the iteration cannot grow an accumulator; it can
decide divergence as~$\bot$ but cannot make additional terms
converge.
...
more defined: $\lambda$-terms that diverge under
$\beta$-reduction may converge, as shown in
Section~\ref{sec:bohm-tree}.
