...
\begin{itemize}
  ...
  \item \emph{The theory.} We prove the solver \emph{sound} (the finite graph it returns
    ...
    on the data that reaches finitely many states, and no solution-preserving procedure halts
    with a finite cyclic graph beyond the rational fragment, Theorems~\ref{thm:termination},
